...
{
	Coordinate ScreenSampl_mio[3] = {{0x0310, 0x023F}, {0x0310, 0x0D8B}, {0x0CA9, 0x098C}};
	Coordinate ScreenSampl_scheda[3] = {{2373, 2522}, {3617, 2499}, {3174, 3637}};
  ...
  } else if (NEED_CALIBRATION == 0)	// emulatore
	 setCalibrationMatrix( &DisplaySample[0],&ScreenSampl_mio[0],&matrix ) ; 
  else
	 setCalibrationMatrix( &DisplaySample[0],&ScreenSampl_scheda[0],&matrix ) ; 
