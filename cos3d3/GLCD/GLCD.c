...
//uint16_t smaller(int16_t a, int16_t b) {
//	return (a<b)?a:b;
//}
//int16_t Xm, Ym;
//int length_sq;
//void LCD_Recursive_DrawLine ( uint16_t x0, uint16_t y0, uint16_t x1, uint16_t y1 , uint16_t color, int lvl ) {
//	length_sq = (x0-x1)*(x0-x1) + (y0-y1)*(y0-y1);
...
//	
//	
//	Xm = abs(x0-x1)/2.0 + smaller(x0,x1);
//	Ym = abs(y0-y1)/2.0 + smaller(y0,y1);
//	
//	LCD_SetPoint(Xm,Ym,color);
//	
//	LCD_Recursive_DrawLine(x0, y0, Xm, Ym, color, lvl+1);
//	LCD_Recursive_DrawLine(Xm+1, Ym+1, x1, y1, color, lvl+1);
//}
uint16_t abs_val(int16_t a) {
	return (a>0)?a:-a;
}
